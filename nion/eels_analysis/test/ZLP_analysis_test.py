...
class TestZLPAnalysis(unittest.TestCase):
    ...
    def test_estimate_zlp_amplitude_position_width_fit_spline(self) -> None:
        max_pos_in = 61.523
        max_height_in = 1e3
        HWHM_in = 8.225
    ...
    def test_estimate_zlp_amplitude_position_width_com(self) -> None:
        max_pos_in = 61.523
        max_height_in = 1e3
        FWHM_in = 8.225
    ...
    def test_estimate_zlp_amplitude_position_width_fails_with_2D_data(self) -> None:
